...
,CASE WHEN product_qty_type LIKE '%unit%' THEN 'unit' ELSE 'bulk'
...
SELECT * FROM vendor as vt
INNER JOIN vendor_booth_assignments as vba
ON vt.vendor_id = vba.vendor_id
...
SELECT vb.vendor_id, v.vendor_name, count(booth_number) as total_assignments
...
HINT: you might need to search for strfrtime (yyyy-mm-dd) modifers sqlite on the web to know what the modifers for month 
and year are! */
